...
> **Примечание:** Я **не профессиональный разработчик**. Этот проект создан с помощью **DeepSeek AI** (и других AI-ассистентов) для обучения и личного использования. В коде могут быть ошибки — улучшения приветствуются!
...
> Не профессиональный разработчик. Создано с помощью **DeepSeek AI**.
